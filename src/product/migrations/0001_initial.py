    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, choices=[('green', 'GREEN'), ('blue', 'BLUE'), ('red', 'RED'), ('orange', 'ORANGE'), ('black', 'BLACK')], max_length=15, null=True)),
                ('size', models.CharField(blank=True, choices=[('xl', 'XL'), ('sm', 'SM'), ('md', 'MD'), ('xs', 'XS')], max_length=15, null=True)),
                ('description', models.TextField()),
